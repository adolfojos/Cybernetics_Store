    ...
    <div class="container text-center">
        ...
        <div class="page">
            ...
            <div class="table-responsive">
                ...
                <p>
                <h3><i class="fa fa-money"></i> Paga con</h3>
                    <a href="{{ route('cart-show') }}" class="btn btn-primary">
                        <i class="fa fa-chevron-circle-left"></i> Regresar
                    </a>

                    <a href="{{ route('payment') }}" class="btn btn-primary">
                     PayPal <i class="fa fa-paypal fa-1x"></i>
                    </a>
                <a href="#" class="btn btn-primary">
                    Mercado Pago <i class="fa fa-credit-card fa-1x"></i>
                </a>
                <a href="#" class="btn btn-primary">
                    Deposito/Transferencia <i class="fa fa-money fa-1x"></i>
                </a>
                </p>
            </div>
        </div>
